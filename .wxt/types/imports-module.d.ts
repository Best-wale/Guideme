...
declare module '#imports' {
  ...
  export { animateCursorToElement, createPulseAnimation, animateClick, animateInput, CursorAnimationOptions } from '../src/utils/animated-cursor';
  export { setupContentScript } from '../src/utils/content-script-setup';
  export { highlightElement, findElementByText, findElementBySelector, smoothScrollToElement, createStepOverlay, HighlightOptions } from '../src/utils/dom-highlighter';
  export { MESSAGE_TYPES, sendMessageToBackground, listenToMessages, getChromeStorageData, setChromeStorageData, generateSessionId } from '../src/utils/messaging';
  export { extractPageContext, sanitizePageContext, getElementBySelectorHint } from '../src/utils/page-context';
}
